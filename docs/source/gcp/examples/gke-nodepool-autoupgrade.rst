...
the control of the cluster master. The policy below will configure all node pools to be upgraded
automatically and have the same initial size, as well as autoscaling constraints.
